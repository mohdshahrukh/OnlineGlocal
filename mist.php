...
<div class = "col-sm-2"> </DIV>
  ...
  <div class = "col-sm-9"><h1 style='color:black'>&nbsp&nbsp  &nbsp&nbsp   &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp About Us  </h1> </DIV>
 </DIV>
...
<div id="showcase" class="noselect">    
 ...
 <a href ="#"> <img class="cloud9-item" src="mist/m.png" alt="Wyzo"> </a> 
 <a href ="#"> <img class="cloud9-item" src="mist/i.jpg" alt="Opera"> </a>
 <a href ="#"> <img class="cloud9-item" src="mist/s.jpg" alt="Chrome"> </a>
 <a href ="#"> <img class="cloud9-item" src="mist/t.jpg" alt="Internet Explorer"></a>
  </div>
...
<script>
 ...
 <div class="row"  >  <center>
	  ...
	  <B><a href ="profile.php?ID=39">M</a></B>aaz <br>
	 
 </div> <div class = "col-sm-3">
	  
	  <B><a href ="profile.php?ID=50">I</a></B>srar
 </div> <div class = "col-sm-3">
	  
	  <B><a href ="profile.php?ID=51">S</a></B>hahrukh
 </div> <div class = "col-sm-3">
	  
	  <B><a href ="profile.php?ID=22">T</a></B>abish
 </div>
