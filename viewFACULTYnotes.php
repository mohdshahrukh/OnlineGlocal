...
if (!isset($_SESSION['id'])) 
{
 ...
 $de = $_SESSION['dept'];
	...
	{
		$get = "SELECT * FROM $table WHERE designation ='Faculty' order by notes_id desc LIMIT 60";
 ...
 $mn = $_POST['mth'];
	...
	$get = "SELECT * FROM $table WHERE date = '$res'AND designation ='Faculty' order by notes_id desc LIMIT 60"; 
	  $run = mysqli_query($con,$get);
	  $a = mysqli_num_rows($run) ;
  ...
  if(isset($_POST['byname']))
	...
	$get =  ("SELECT * FROM $table  WHERE (keywords LIKE '%$res%' OR  topic LIKE '%$res%' OR sub LIKE '%$res%' OR descp LIKE '%$res%') AND designation ='Faculty' order by notes_id desc LIMIT 60");
...
<div class = "col-sm-2"> </DIV> 
  ...
  <div class = "col-sm-9">   	<h1>&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp  &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp <b>FACULTY NOTES</b> </h1>	   </DIV>
 </DIV> 
 <div class="row"  >  
      <div class = "col-sm-3">
 <div class="row"  > 
