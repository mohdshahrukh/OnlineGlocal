...
$table = 'user';
 $de = $_SESSION['dept'];
  ...
  $a = mysqli_num_rows($run) ;
	...
	//code is copied from viewnotes so variable name can cause confusion please avoid...
 ...
 $mn = $_POST['mth'];
	...
	$get = "SELECT * FROM $table WHERE dept = '$res'";
	  $run = mysqli_query($con,$get);
	  $a = mysqli_num_rows($run) ;
  ...
  if(isset($_POST['byname']))
	...
	$get =  ("SELECT * FROM $table  WHERE username LIKE '%$res%'");
...
<div class = "col-sm-2"> </DIV> 
  ...
  <div class = "col-sm-9"> 	<h1>&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp  &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp All Members </h1>	 </DIV>
 </DIV> 
 <div class="row"  >  
      <div class = "col-sm-3">
 <div class="row"  > 
...
<div class = "col-sm-2"> </DIV> 
 ...
 <center>    <form method="POST" class="form-inline" role="form"  >
	...
	<option >School of Life Science</option>
	<option >School of Management</option>
	<option >School of Mass Communication</option>
	<option >Glocal Medical College</option>
	<option >School of Pharmacy</option>
    <option >School of Polytechnic</option>   
 ...
 <div class="table-responsive" id="t">
      <table class="table">
         <tr>
             <th id = "a">Profile Pic</th>
             <th id="b">Name</th>
             <th id="c">Department</th>
			  <th id="d">Course</th>
             <th id="e">Designation</th>
...
{$ft = "<a href = 'user_notes/$file'><img src ='FILE_TYPE/zip.png'</a>" ; }	
	...
	*/
	...
	{?>                            <table class="table" id="q"  >  <tr>
                        <td id ="a">  <a href = 'profile.php?ID=<?=$u_id?>'><img src="compressed_udp/<?=$file?>"></a></td>
						<td id ="b" ><a href = 'profile.php?ID=<?=$u_id?>'><?=$nam?></a> </td>     
    <td id ="c"> <?=$sub?></td>
    <td id ="d">
          <?=$topic?></td>
    <td id ="e">
