...
(21, 'tabish tanseef', 'Faculty', 'SE', 'kiy', '20366-mohd_Israr_resume.docx', 'mkioooo', 'mjiii', '17-Jan-2017', '12:35:58 PM', 52, 'docx');
...
(22, 22, '82800-2017-01-01-08-12-16-529.jpg', 'haxKJSHAKSI', '23-Jan-2017', '09:13:44 AM', 'Tabish Tanseef');
...
CREATE TABLE IF NOT EXISTS `feedbackhandling` (
...
(4, 'mn', 'Faculty', 'SE', 'model', '29363-01-SE-Intro-notes.pdf', 'mjnhjbgvyi', 'bhbjhun s e', '17-Jan-2017', '12:09:33 PM', 30, 'pdf');
...
(22, 'Tabish Tanseef', 'tabishtanseef@gmail.com', 'tabish', '82800-2017-01-01-08-12-16-529.jpg', 'School of Computer Science', 'B.tech', 'student'),
...
(29, 'nn', 'nabeelazam4321@gmail.com', 'nn', '62398-medical.sql', 'School of Computer Science', 'None', 'Student'),
(30, 'mn', 'Maz@gmail.com', 'mn', '44412-eclipse.exe', 'School of Computer Science', 'None', 'Faculty'),
...
(52, 'tabish tanseef', 'tabbu@gmail.com', 'abc', '42346-download.png', 'School of Computer Science', 'B.tech', 'Faculty');
...
--
ALTER TABLE `computer_science`
MODIFY `notes_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `feedback`
MODIFY `msg_id` int(22) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `technology`
MODIFY `notes_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
