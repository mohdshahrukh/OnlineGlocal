...
if (!isset($_SESSION['id'])) 
{
 ...
 $de = $_SESSION['dept'];
	...
	{
		$get = "SELECT * FROM $table WHERE designation ='student' order by notes_id desc LIMIT 60";
 ...
 $mn = $_POST['mth'];
	...
	$get = "SELECT * FROM $table WHERE date = '$res'AND designation ='student' order by notes_id desc LIMIT 60";
	  $run = mysqli_query($con,$get);
	  $a = mysqli_num_rows($run) ;
  ...
  if(isset($_POST['byname']))
	...
	$get =  ("SELECT * FROM $table  WHERE (keywords LIKE '%$res%' OR  topic LIKE '%$res%' OR sub LIKE '%$res%' OR descp LIKE '%$res%') AND designation ='student' order by notes_id desc LIMIT 60");
...
<div class = "col-sm-2"> </DIV> 
  ...
  <div class = "col-sm-9">   	<h1>&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp  &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp <b>STUDENT NOTES</b> </h1>	   </DIV>
 </DIV> 
 <div class="row"  >  
      <div class = "col-sm-3">
 <div class="row"  > 
...
<div class = "col-sm-2"> </DIV> 
 ...
 <form method="POST" class="form-inline" role="form"  >
	...
	<br> <label style="color: black;">or search by keywords...!!!</label>   <input type="text" class="form-control" size="28" name="topic_name" required  /> <br>
   <br> <button type= "submit" name = "byname" class="btn btn-default" >Go...!!!</button>
 </form> </center>
...
{$ft = "<a href = 'user_notes/$file'><img src ='FILE_TYPE/zip.png'</a>" ; }	
  ...
  <?php } }
  if ($a == 0)
	{ echo "<h3><center><br>0 notes available</center></h2>" ; }
