...
<body onload="window.scrollTo(1000000000,0);>
...
<div class = "col-sm-2"> </DIV> 
 ...
 <center><h2><?php echo $vella; ?> </h2> </center>
	...
	{?>                            
             <h3>       <a href = 'profile.php?ID=<?=$u_id?>'><?=$nam?></a> </h3> <br>                        
						<a id="c" href = 'profile.php?ID=<?=$u_id?>'><img src="compressed_udp/<?=$file?>"></a>    
					 <table class="table">  <tr> <td> 	<h3> <?=$sub?> </h3><br> <b>  <?=$date?>&nbsp &nbsp
							<?=$time?></b> </td></tr>  
...
//  $a = mysqli_num_rows($r) ;
 ...
 $p = $_SESSION['pic'];
	...
	header("location:newrepl.php?ID=$i");		}
